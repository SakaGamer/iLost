...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imgGoogle = findViewById(R.id.google_login);
        imgGoogle.setOnClickListener(this);

        imgFacebook = findViewById(R.id.fb_login);
        imgFacebook.setOnClickListener(this);

        ImageView imgTwitter = findViewById(R.id.twitter_login);
        imgTwitter.setOnClickListener(this);

        ImageView imgPhone = findViewById(R.id.phone_login);
